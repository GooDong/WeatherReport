...
public class PullToRefreshView extends LinearLayout {
	 ...
	 * last update time
	 */
	private boolean isFooterNeeded = false;
	...
	public void setLastUpdated(CharSequence lastUpdated) {
		if (lastUpdated != null) {
			mHeaderUpdateTextView.setVisibility(View.VISIBLE);
			mHeaderUpdateTextView.setText("最后刷新时间:"+lastUpdated);
		} else {
	...
	public boolean isFooterNeeded() {
		return isFooterNeeded;
	}

	public void setFooterNeeded(boolean isFooterNeeded) {
		this.isFooterNeeded = isFooterNeeded;
	}
